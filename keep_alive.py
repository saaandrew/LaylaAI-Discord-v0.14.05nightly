    ...
    <body>
        ...
        <div class="commands-container">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="https://github.com/saaandrew/LaylaAI-DiscordBot" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #fabb34; color: #fff; border-radius: 50px;">View Source Code on GitHub</a>
            </div>
        </div>
    </body>
    </html>
